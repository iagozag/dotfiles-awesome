...
local pactl = require("sentinl.wibar.widgets.pactl-widget.pactl")
local utils = require("sentinl.wibar.widgets.pactl-widget.utils")

local widget_types = {
    icon_and_text = require("sentinl.wibar.widgets.volume-widget.widgets.icon-and-text-widget"),
    icon = require("sentinl.wibar.widgets.volume-widget.widgets.icon-widget"),
    arc = require("sentinl.wibar.widgets.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("sentinl.wibar.widgets.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("sentinl.wibar.widgets.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
